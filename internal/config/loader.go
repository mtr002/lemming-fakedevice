...
func mergeWithDefaults(userConfig *configpb.LemmingConfig) *configpb.LemmingConfig {
	...
	if userConfig != nil && userConfig.Interfaces != nil {
		config.Interfaces = userConfig.Interfaces
	} else {
		config.Interfaces = getDefaultInterfaces()
	}

	if userConfig != nil && userConfig.LinkQualification != nil {
		config.LinkQualification = userConfig.LinkQualification
	} else {
		config.LinkQualification = getDefaultLinkQualification()
	}
...
// getDefaultInterfaces returns default interface configuration
func getDefaultInterfaces() *configpb.InterfaceConfig {
...
// getDefaultLinkQualification returns default link qualification configuration
func getDefaultLinkQualification() *configpb.LinkQualificationConfig {
