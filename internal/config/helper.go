...
func GetInterfaceByName(config *configpb.LemmingConfig, name string) *configpb.InterfaceSpec {
...
func GetInterfaceByIndex(config *configpb.LemmingConfig, ifIndex uint32) *configpb.InterfaceSpec {
	if config.GetInterfaces() == nil {
		return nil
	}
	for _, iface := range config.GetInterfaces().GetInterface() {
...
func GetAllInterfaceNames(config *configpb.LemmingConfig) []string {
	if config.GetInterfaces() == nil {
		return nil
	}
...
func IsValidInterfaceName(config *configpb.LemmingConfig, name string) bool {
