...
func extractPacketConfiguration(config *plqpb.QualificationConfiguration, cfg *configpb.LemmingConfig) *PacketConfiguration {
...
func extractQualificationTiming(config *plqpb.QualificationConfiguration, cfg *configpb.LemmingConfig) *QualificationTiming {
